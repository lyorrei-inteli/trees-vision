...
class Configuration:
    def __init__(self):
        ...
        self.input_image_dir = (
            "/Users/lyo.quintao/development/TreeCountSegHeight/example_1km_tile_tif/"
        )
        self.input_image_type = ".tif"  #'.tif'#'.jp2'
        self.input_image_pref = (
            ""  # prefix of image file names, can be used to filter out images
        )
        self.channel_names1 = [
            "red",
            "green",
            "blue",
        ]  # if four color bands, set to ['red', 'green', 'blue', 'infrared']
        self.channels = [
            0,
            1,
            2,
        ]  # to take color bands in the correct order (match with the model)
        self.rgb2gray = (
            0  # set to 1 if using only grayscale image (convert rgb band to grayscale)
        )
        self.band_switch = (
            0  # set to 1 if using only subset of bands or change the order of bands
        )
        self.addndvi = 0
        # model downloadable with the google drive link
        self.trained_model_path = "/Users/lyo.quintao/development/TreeCountSegHeight/saved_models/trees_20210620-0202_Adam_e4_redgreenblue_256_84_frames_weightmapTversky_MSE100_5weight_attUNet.h5"
        ...
        self.inputBN = False
        self.output_dir = "/Users/lyo.quintao/development/TreeCountSegHeight/example_1km_tile_tif/predictions/"
