...
def UNet(
    ...
    input_img1 = layers.Input(
        (input_shape[1], input_shape[2], input_shape[3]), name="Input1"
    )
    ...
    c11 = layers.Conv2D(1 * layer_count, (3, 3), activation="relu", padding="same")(
        input_img2
    )
    c110 = layers.Conv2D(1 * layer_count, (3, 3), activation="relu", padding="same")(
        c11
    )
